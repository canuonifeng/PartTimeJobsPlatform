...
public class OssStsServiceImpl implements OssStsService {
    ...
    private static final String BIZ_LICENSE = "license";
    private static final String BIZ_LOGO = "logo";
    private static final String BIZ_JOB = "job";
    ...
    public OssStsVO issueSts(Long companyId, String biz) {
        ...
        String bucket;
        String prefix;
        if (BIZ_LICENSE.equals(biz)) {
            bucket = ossProperties.getPrivateBucket();
            prefix = BIZ_LICENSE + "/" + companyId + "/";
        } else if (BIZ_LOGO.equals(biz)) {
            bucket = ossProperties.getPublicBucket();
            prefix = BIZ_LOGO + "/" + companyId + "/";
        } else if (BIZ_JOB.equals(biz)) {
            bucket = ossProperties.getPublicBucket();
            prefix = BIZ_JOB + "/" + companyId + "/";
        } else {
