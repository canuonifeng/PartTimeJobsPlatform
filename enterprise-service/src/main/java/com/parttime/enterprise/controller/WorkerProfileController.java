...
public class WorkerProfileController {
    ...
    @GetMapping("/profile")
    public ApiResponse<WorkerProfileVO> getProfile(@Parameter(description = "工人ID") @RequestParam Long workerId,
                                      @Parameter(description = "企业ID") @RequestParam Long companyId) {
        return ApiResponse.success(workerProfileService.getWorkerProfile(companyId, workerId));
    }
    ...
    public ApiResponse<List<EvaluationVO>> getEvaluations(@Parameter(description = "工人ID") @RequestParam Long workerId,
                                              @Parameter(description = "企业ID") @RequestParam Long companyId) {
        return ApiResponse.success(workerProfileService.getEvaluations(workerId, companyId));
    }
    ...
    public ApiResponse<List<WorkHistoryVO>> getWorkHistory(@Parameter(description = "工人ID") @RequestParam Long workerId,
                                               @Parameter(description = "企业ID") @RequestParam Long companyId) {
        return ApiResponse.success(workerProfileService.getWorkHistory(workerId, companyId));
    }
}
