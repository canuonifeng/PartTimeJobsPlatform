...
public class CorrectionServiceTest {
    ...
    static class TestWorkerSyncMapper implements WorkerSyncMapper {
        ...
        @Override public String findWorkerGenderById(Long workerId) { return null; }
        @Override public String findWorkerRealNameStatusById(Long workerId) { return "NONE"; }
        ...
        @Override public List<Map<String, Object>> findWorkerRealNameStatusesByIds(List<Long> ids) { return List.of(); }
    }
    ...
    static class TestJobMapper implements JobMapper {
        ...
        @Override public List<Job> findByCompanyIdAndTaskType(Long companyId, String taskType) { return List.of(); }
