...
class PayrollControllerTest {
    ...
    void createBatch_shouldReturnCreated() throws Exception {
        ...
        when(payrollService.createBatch(any(PayrollBatchRequest.class))).thenReturn(response);
        ...
        verify(payrollService).createBatch(any(PayrollBatchRequest.class));
    }
    ...
    void getBatchesByCompany_shouldReturnBatches() throws Exception {
        PayrollBatchResponse batch = new PayrollBatchResponse();
        batch.setId(1L);
    ...
    void getBatchItems_shouldReturnItems() throws Exception {
        PayrollItemResponse item = new PayrollItemResponse();
        item.setId(1L);
