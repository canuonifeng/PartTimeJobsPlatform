...
零工平台是一套面向灵活用工场景的招聘与用工管理系统，连接企业、兼职人员与平台运营方，覆盖招聘计划、班次发布、报名审核、排班考勤、薪资结算等核心流程。

平台包含工人端、企业端和平台端三类产品：工人可通过小程序浏览岗位、选择班次报名、查看排班、打卡和提现；企业可通过小程序或 PC 后台创建招聘计划、发布班次、审核报名、管理考勤并完成薪资结算；平台运营方可通过管理后台维护企业、工人、岗位分类和系统配置。
